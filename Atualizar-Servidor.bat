...
REM  Busca a versao mais nova na pasta do GOOGLE DRIVE (privada) e ja sobe o servidor.
REM  (Requer o Google Drive instalado/sincronizado nesta maquina.)
...
echo   1) Busca a versao mais nova (Google Drive - privado)
